    ...
    <DIV className={`${className}`}>
         ...
         <div className=" social-media-container font-1-1 mt-1">
                 <div className="social display-flex  mt-2 justify-content-space-between">
                         <div className="social-media-btn border-radius-5 w-49 display-flex align-items-center cursor-p justify-content-center p-1">
          ...
          {/* Or Text */}
          <div className="or-text text-color-grey text-center mt-3">
               Or
          </div>
